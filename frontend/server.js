...
var app = express();
//app.use('/static', express.static('ticketmaster/dist/ticketmaster/index.html'));
app.use(cors());
...
app.get('/event_details', async function (request, res) {
    ...
    await axios.get(apiUrl).then(response => {
        ...
        console.log("Respose of details:");
        console.log(events);
        ...
        names = "";
        genreArtst = "";
        console.log("Embedded, attractions:");
        console.log(events["_embedded"]["attractions"]);
...
async function getArtistDetails(artistName){
    ...
    resp = {};
    console.log("ref data:"+refinedData[0].name.toLowerCase());
    console.log("ref data input:"+artistName.toLowerCase());
    console.log((refinedData[0].name.toLowerCase()).localeCompare(artistName.toLowerCase()));
    if((refinedData[0].name.toLowerCase()).localeCompare(artistName.toLowerCase()) === 0){
